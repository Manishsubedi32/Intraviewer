...
so we are not creating data logic here, but rather we are directly applying data logic
from services as it acts as both functional business logic and data access logic
